<div class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Add Coapplicant</div>
        <div class="panel-body">
        <?php echo $this->Form->create('Coapplicant', array( 'controller' => 'Coapplicants', 'action' => "add/$clientId",'name'=>'post_req','id'=>'post_req','class'=>'form-horizontal','type'=>'file'));?>
            <div class="panel panel-default">
            <div class="panel-heading"><strong>Co-Applicant Information</strong></div>
            <div class="panel-body">
            ...
            <div class="form-group text-left">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <?php echo$this->Html->link('<span class="fa fa-close"></span> Close',array('action'=>'index',$clientId),array('class'=>'btn btn-danger','escape'=>false));?>
                </div>
            </div>
