<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Currencies')); echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;Add New Currency',array('controller'=>'Currencies','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span>Currency</span></h4>
			</div>
		</div>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('name', 'Currency Name', array('direction' => 'asc'));?></th>
                            <th>Currency</th>
                            <th>Action</th>
                        </tr>
