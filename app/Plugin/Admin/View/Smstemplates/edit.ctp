...
<?php echo $this->Session->flash();?>
    <div class="col-md-12">
        <div class="panel panel-default mrg">
            <div class="panel-heading"><div class="widget-modal"><h4 class="widget-modal-title">Edit <span>SMS templates</span></strong></h4><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div></div>
		  ...
		  <div class="panel-body">
		    <div class="form-group">
			  ...
			  <div class="col-sm-6">
			     <?php echo $this->Form->input("$k.Smstemplate.name",array('label' => false,'class'=>'form-control','placeholder'=>'Name','div'=>false));?>
			  </div>
		    </div>
		     <div class="form-group">
			  <label for="group_name" class="col-sm-4 control-label"><small>Template:</small></label>
			  <div class="col-sm-6">
			     <?php echo $this->Form->input("$k.Smstemplate.description",array('label' => false,'class'=>'form-control','placeholder'=>'Template','div'=>false));?>
			  </div>
		    </div>
		    <div class="form-group">
