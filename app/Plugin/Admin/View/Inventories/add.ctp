    ...
    <div class="panel panel-default">
        ...
        <?php echo $this->Form->create('Inventory', array( 'controller' => 'Inventories', 'action' => 'add','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                   <?php echo $this->Form->input('invoice_qty',array('label' => false,'class'=>'form-control','placeholder'=>'Quantity','div'=>false));?>
                </div>
            </div>                     
            <div class="form-group">
            ...
            <div class="form-group text-left">
                <div class="col-sm-offset-4 col-sm-6">
                    ...
                    <?php echo$this->Html->link('<span class="fa fa-close"></span> Close',array('controller'=>'Inventories','action'=>'index'),array('class'=>'btn btn-danger','escape'=>false));?>
                </div>
            </div>
