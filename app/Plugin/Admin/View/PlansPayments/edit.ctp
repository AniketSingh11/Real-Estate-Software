...
<?php echo $this->Session->flash();?>
    <div class="col-md-12">
        <div class="panel panel-default mrg">
            <div class="panel-heading"><div class="widget-modal"><h4 class="widget-modal-title">Edit <span>Payments</span></strong></h4><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div></div>
		...
		<div class="panel panel-default">
		 ...
		 <div class="form-group">
            <label for="group_name" class="col-sm-3 control-label"><small>Installment Name:</small></label>
            <div class="col-sm-6">
               <?php echo $this->Form->input("$k.PlansPayment.name",array('label' => false,'class'=>'form-control ','placeholder'=>'Installment Name','div'=>false));?>
            </div>
        </div>
        <div class="form-group">
            <label for="group_name" class="col-sm-3 control-label"><small>Amount:</small></label>
            <div class="col-sm-6">
               <?php echo $this->Form->input("$k.PlansPayment.amount",array('label' => false,'class'=>'form-control','placeholder'=>'Amount','div'=>false));?>
            </div>
        </div>
        <div class="form-group">
