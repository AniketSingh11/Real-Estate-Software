<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;Add New Plan',array('controller'=>'Plans','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span>Plans</span></h4>
			</div>
		</div>
			    ...
			    <td><span class="label label-<?php if($post['Plan']['status']=="Active")echo"success";else echo"danger";?>"><?php echo h($post['Plan']['status']); ?></span></td>
