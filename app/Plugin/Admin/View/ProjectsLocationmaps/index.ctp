<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-arrow-left"></span>&nbsp;Back To Projects',array('controller' => 'Projects','action'=>'index'),array('escape' => false,'class'=>'btn btn-info'));?>
            <?php $url=$this->Html->url(array('controller'=>'ProjectsLocationmaps')); echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;Add New Location Map','#',array('name'=>'add','id'=>'add','onclick'=>"check_perform_add('$url/add/$projectId');",'escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span>Location Maps</span></h4>
			</div>
		</div>
			    ...
			    <th><?php echo 'Photo';?></th>
                        ...
                        <?php $serial_no=1; foreach ($ProjectsLocationmap as $post):
                        $id=$post['ProjectsLocationmap']['id'];?>
                        <tr>
                            <td><?php echo $this->Form->checkbox(false,array('value' => $post['ProjectsLocationmap']['id'],'name'=>'data[ProjectsLocationmap][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
                            <td><?php echo $serial_no++; ?></td>
			    <td><?php echo $this->Html->image($post['ProjectsLocationmap']['dir'].'_thumb/'.$post['ProjectsLocationmap']['photo'],array('class'=>'img-thumbnail')); ?></td>
