...
<div <?php if(!$isError){?>class="container"<?php }?>>
    ...
    <div class="panel panel-custom mrg">
        <div class="panel-heading">Add Slides<?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div>
                ...
                <?php echo $this->Form->create('Slide', array( 'controller' => 'Slide', 'action' => 'add','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal','type'=>'file'));?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                           <?php echo $this->Form->input('slide_name',array('label' => false,'class'=>'form-control','placeholder'=>'Slide Name','div'=>false));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="group_name" class="col-sm-3 control-label"><small>Ordering</small></label>
                        <div class="col-sm-9">
                           <?php echo $this->Form->input('ordering',array('label' => false,'class'=>'form-control','placeholder'=>'Ordering','div'=>false));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="group_name" class="col-sm-3 control-label"><small>Upload Slide (1140*350)</small></label>
                        <div class="col-sm-9">
