<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;Add New Unit',array('controller'=>'Units','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span>Units</span></h4>
			</div>
		</div>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('name', 'Unit', array('direction' => 'asc'));?></th>
                            <th>Action</th>
                        </tr>
