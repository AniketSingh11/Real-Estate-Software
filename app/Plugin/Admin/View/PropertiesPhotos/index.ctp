<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-arrow-left"></span>&nbsp;Back To Property',array('controller' => 'Properties','action'=>'index'),array('escape' => false,'class'=>'btn btn-info'));?>
            <?php $url=$this->Html->url(array('controller'=>'PropertiesPhotos')); echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;Add New Photo','#',array('name'=>'add','id'=>'add','onclick'=>"check_perform_add('$url/add/$propertyId');",'escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span>Property Photo</span></h4>
			</div>
		</div>
