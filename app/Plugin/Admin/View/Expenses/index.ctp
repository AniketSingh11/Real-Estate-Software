    ...
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			?>
			    ...
			    <?php if($status!="Paid"){?><li><?php echo $this->Html->link('<span class="fa fa-dollar"></span>&nbsp;Make Payment',array('controller'=>'expenses_payments','action'=>'add',$id),array('escape'=>false));?></li><?php }?>
