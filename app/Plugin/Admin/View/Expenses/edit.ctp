...
<?php echo $this->Session->flash();?>
    <div class="col-md-12">
        <div class="panel panel-default mrg">
            <div class="panel-heading"><div class="widget-modal"><h4 class="widget-modal-title">Edit <span>Expenses</span></strong></h4><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div></div>
                <div class="panel-body">
					<?php echo $this->Form->create('Expense', array( 'controller' => 'Expenses','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
					<?php foreach ($Expense as $k=>$post): $id=$post['Expense']['id'];$form_no=$k+1;?>
		  ...
		  <div class="panel-body">
		    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                           <?php echo $this->Form->select("$k.Expense.project_id",$projectName,array('label' => false,'class'=>'form-control','empty'=>'Please Select','div'=>false));?>
                        </div>
                    </div>
		    <div class="form-group">
                        <label for="group_name" class="col-sm-4 control-label"><small>Category Name:</small></label>
                        <div class="col-sm-6">
                           <?php echo $this->Form->select("$k.Expense.expense_category_id",$expenseCategory,array('label' => false,'class'=>'form-control','empty'=>'Please Select','div'=>false));?>
                        </div>
                    </div>
		    <div class="form-group">
                        <label for="group_name" class="col-sm-4 control-label"><small>Vendor/Staff Name:</small></label>
                        <div class="col-sm-6">
                           <?php echo $this->Form->select("$k.Expense.vendor_id",$vendorName,array('label' => false,'class'=>'form-control','empty'=>'Please Select','div'=>false));?>
                        </div>
                    </div>
		    <div class="form-group">
                        <label for="group_name" class="col-sm-4 control-label"><small>Invoice No.:</small></label>
                        <div class="col-sm-6">
                           <?php echo $this->Form->input("$k.Expense.invoice_no",array('label' => false,'class'=>'form-control','placeholder'=>'Invoice No.','div'=>false));?>
                        </div>
                    </div>
		    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                           <?php echo $this->Form->input("$k.Expense.invoice_amount",array('label' => false,'class'=>'form-control','placeholder'=>'Invoice Amount','div'=>false));?>
                        </div>
                    </div>                    
                    <div class="form-group">
                        <label for="group_name" class="col-sm-4 control-label"><small>Remarks:</small></label>
                        <div class="col-sm-6">
                           <?php echo $this->Form->input("$k.Expense.remarks", array('label'=>false,'placeholder'=>'Remarks','class'=>'form-control')); ?>
                        </div>                                           
                    </div>
