<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;Add New Vendors / Staff',array('controller'=>'Vendors','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
			...
			<div class="widget">
				<h4 class="widget-title"> <span>Vendors / Staff</span></h4>
			</div>
		</div>
			    ...
			    <th><?php echo $this->Paginator->sort('contact', 'Mobile', array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('address', 'Address', array('direction' => 'asc'));?></th>
			    <th><?php echo $this->Paginator->sort('licence_no', 'Licence No.', array('direction' => 'asc'));?></th>
                            <th>Action</th>
                        </tr>
