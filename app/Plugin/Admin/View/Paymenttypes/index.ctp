<div class="row">
    <div class="col-md-12">
	    ...
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;Add New Payment Type',array('controller'=>'Paymenttypes','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('name', 'Payment Type', array('direction' => 'asc'));?></th>
                            <th>Action</th>
                        </tr>
